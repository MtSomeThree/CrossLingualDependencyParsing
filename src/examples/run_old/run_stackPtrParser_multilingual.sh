UDA_VISIBLE_DEVICES=2 python2 examples/StackPointerParser.py --mode FastLSTM --num_epochs 1000 --batch_size 32 --decoder_input_size 256 \
 --hidden_size 512 --encoder_layers 3 --decoder_layers 1 \
 ...
 --model_path "models/parsing/stack_ptr/" --model_name 'network_multilingual_embfrozen.pt'
