...
CUDA_VISIBLE_DEVICES=$1 python2 examples/StackPointerParser.py --mode FastLSTM --num_epochs 1000 --batch_size 32 --decoder_input_size 256 \
 --hidden_size 200 --encoder_layers 3 --decoder_layers 1 \
 ...
 --word_embedding word2vec --word_path "../../../../kwchang/npeng/embeddings/bilingual/wiki.multi.en_zh.vec" --char_embedding random \
 ...
 --test "data/udt_google/Chinese/zh-ud-test.upos.conll" \
 --model_path "models/parsing/stack_ptr_en_zh_rnn_off/" --model_name 'network.pt'
