...
def main():
    ...
    args_parser.add_argument('--decode', choices=['mst', 'greedy', 'proj'], default='mst', help='decoding algorithm')
    ...
    args_parser.add_argument('--constraints_method', type=str, choices=['Lagrange', 'binary', 'PR'], default='binary', help='constraints training method')
    args_parser.add_argument('--tolerance', type=float, default=0.003)
    args_parser.add_argument('--constraint_file', type=str)
